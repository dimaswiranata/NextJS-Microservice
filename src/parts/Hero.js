    ...
    <div className="flex justify-between items-center">
      ...
      <div className="w-1/2">
        ...
        <form onSubmit={submit}>
          ...
          <button className="bg-orange-500 hover:bg-orange-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-6 py-3">Daftar Sekarang</button>
        </form>
      </div>
      ...
      <div className="w-1/2 flex justify-end pt-24 pr-16">
        ...
        <div className="relative" style={{width: 369, height: 440}}>
          ...
          {/* absolute -> gap top and make a border */}
          <div className="absolute border-indigo-700 border-2 -mt-12 -mr-6 right-0" style={{ width: 324, height: 374}}></div>
          
          {/* absolute -> img hero */}
          <div className='absolute w-full h-full -mb-8 -ml-8'>
            <img src="/images/img-hero-mbak-alyssa-cakep.jpg" alt="mbak Alyssa"/>
          </div>

          {/* absolute z-index 10 -> caption */}
          <div className="absolute z-10 bg-white py-3 px-4 mt-24" style={{ transform: "translate(-50%)", width: 290}}>
